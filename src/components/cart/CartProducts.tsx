...
const CartProducts = () => {
      //@ts-ignore
      const cart = useSelector((state) => state.shopping.productCart)
            ...
            <div>
                  <Container className="py-10">
                        {cart.length ? (
                              <div>
                                    <div>
                                          <h1 className="text-3xl md:text-3xl text-gray-700 font-medium tracking-wide">
                                                Shopping Cart
                                          </h1>
                                    </div>
                                    <div className="flex flex-col lg:flex-row justify-between gap-6 mt-10">
                                          <div className="lg:w-2/3 w-full border-t-2 border-r-2 lg:border-r-2 border-l-2 border-gray-300 ">
